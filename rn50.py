...
weight_dir = "./resnet50_weight"
txt_path = os.path.join(weight_dir, "loss.txt")
os.makedirs(weight_dir, exist_ok=True)
print("train...")

def train_model(model, train_loader, criterion, optimizer, num_epochs=10, save_path="./resnet50_weight/resnet50.pth"):
    accuracy = 0
...
train_model(model, train_loader, criterion, optimizer, num_epochs=20,
            save_path=os.path.join(weight_dir, "resnet50.pth"))
...
weight_path = './resnet50_weight/resnet50.pth'
